...
| Status | Descrição | Schema |
| --- | --- | --- |
| 200 | OK | array&lt;entity.Tag&gt; |
| 400 | Bad Request | object |
| 500 | Internal Server Error | object |

## GET `/tags/{id}`

**Resumo:** Get a single tag
...
| X-Workspace-ID | header | string | sim | Workspace ID |
| id | path | string | sim | Tag ID |
| tag | body | v1.updateTagRequest | sim | Tag update object |
...
| --- | --- | --- | --- | --- |
| X-Workspace-ID | header | string | sim | Workspace ID |
| tag | body | v1.createTagRequest | sim | Tag object |

### Respostas

| Status | Descrição | Schema |
| --- | --- | --- |
| 201 | Created | entity.Tag |
| 400 | Bad Request | object |
| 500 | Internal Server Error | object |
