...
DROP TYPE IF EXISTS liquidity_type;
...
CREATE TYPE "investment_type" AS ENUM ('renda_fixa', 'renda_variavel', 'tesouro_direto');

CREATE TYPE "index_type" AS ENUM ('CDI', 'IPCA', 'SELIC', 'FIXED');

CREATE TYPE "liquidity_type" AS ENUM ('daily', 'monthly', 'at_maturity');
...
CREATE TYPE "integration_source" AS ENUM ('mobills');
...
CREATE TABLE
    "recurring_transactions_tags" (
        PRIMARY KEY ("recurring_transactions_id", "tag_id"),
...
ALTER TABLE recurring_transactions_tags ADD CONSTRAINT fk_recurring_transactions_tags_transaction_id FOREIGN KEY (recurring_transactions_id) REFERENCES recurring_transactions (id) ON DELETE CASCADE;

ALTER TABLE recurring_transactions_tags ADD CONSTRAINT fk_recurring_transactions_tags_tag_id FOREIGN KEY (tag_id) REFERENCES tags (id) ON DELETE CASCADE;

ALTER TABLE incomes_tags ADD CONSTRAINT fk_incomes_tags_income_id FOREIGN KEY (income_id) REFERENCES incomes (id) ON DELETE CASCADE;

ALTER TABLE incomes_tags ADD CONSTRAINT fk_incomes_tags_tag_id FOREIGN KEY (tag_id) REFERENCES tags (id) ON DELETE CASCADE;

ALTER TABLE expenses_tags ADD CONSTRAINT fk_expenses_tags_expense_id FOREIGN KEY (expense_id) REFERENCES expenses (id) ON DELETE CASCADE;

ALTER TABLE expenses_tags ADD CONSTRAINT fk_expenses_tags_tag_id FOREIGN KEY (tag_id) REFERENCES tags (id) ON DELETE CASCADE;

ALTER TABLE investments_tags ADD CONSTRAINT fk_investments_tags_investment_id FOREIGN KEY (investment_id) REFERENCES investments (id) ON DELETE CASCADE;

ALTER TABLE investments_tags ADD CONSTRAINT fk_investments_tags_tag_id FOREIGN KEY (tag_id) REFERENCES tags (id) ON DELETE CASCADE;

ALTER TABLE card_expense_tags ADD CONSTRAINT fk_card_expense_tags_expense_id FOREIGN KEY (card_expense_id) REFERENCES card_expenses (id) ON DELETE CASCADE;

ALTER TABLE card_expense_tags ADD CONSTRAINT fk_card_expense_tags_tag_id FOREIGN KEY (tag_id) REFERENCES tags (id) ON DELETE CASCADE;
...
ALTER TABLE cards ADD CONSTRAINT fk_cards_account_id FOREIGN KEY (account_id) REFERENCES accounts (id) ON DELETE CASCADE;

ALTER TABLE investments ADD CONSTRAINT fk_investments_account_id FOREIGN KEY (account_id) REFERENCES accounts (id) ON DELETE CASCADE;

ALTER TABLE recurring_transactions ADD CONSTRAINT fk_recurring_transactions_account_id FOREIGN KEY (account_id) REFERENCES accounts (id) ON DELETE CASCADE;

ALTER TABLE transfers ADD CONSTRAINT fk_transfers_source_account_id FOREIGN KEY (source_account_id) REFERENCES accounts (id) ON DELETE CASCADE;

ALTER TABLE transfers ADD CONSTRAINT fk_transfers_destination_account_id FOREIGN KEY (destination_account_id) REFERENCES accounts (id) ON DELETE CASCADE;

ALTER TABLE incomes ADD CONSTRAINT fk_incomes_account_id FOREIGN KEY (account_id) REFERENCES accounts (id) ON DELETE CASCADE;

ALTER TABLE expenses ADD CONSTRAINT fk_expenses_account_id FOREIGN KEY (account_id) REFERENCES accounts (id) ON DELETE CASCADE;

ALTER TABLE card_payments ADD CONSTRAINT fk_card_payments_account_id FOREIGN KEY (account_id) REFERENCES accounts (id) ON DELETE CASCADE;

-- Excluir fatura remove despesas e pagamentos do cartão
ALTER TABLE card_expenses ADD CONSTRAINT fk_card_expenses_invoice_id FOREIGN KEY (invoice_id) REFERENCES invoices (id) ON DELETE CASCADE;

ALTER TABLE card_chargebacks ADD CONSTRAINT fk_card_chargebacks_invoice_id FOREIGN KEY (invoice_id) REFERENCES invoices (id) ON DELETE CASCADE;

ALTER TABLE card_payments ADD CONSTRAINT fk_card_payments_invoice_id FOREIGN KEY (invoice_id) REFERENCES invoices (id) ON DELETE CASCADE;

-- Excluir investimento remove movimentações
ALTER TABLE investment_deposit ADD CONSTRAINT fk_investment_deposit_investment_id FOREIGN KEY (investment_id) REFERENCES investments (id) ON DELETE CASCADE;

ALTER TABLE investment_withdrawal ADD CONSTRAINT fk_investment_withdrawal_investment_id FOREIGN KEY (investment_id) REFERENCES investments (id) ON DELETE CASCADE;
...
ALTER TABLE incomes ADD CONSTRAINT fk_incomes_category_id FOREIGN KEY (category_id) REFERENCES categories (id) ON DELETE RESTRICT;

ALTER TABLE incomes ADD CONSTRAINT fk_incomes_subcategory_id FOREIGN KEY (subcategory_id) REFERENCES subcategories (id) ON DELETE SET NULL;

ALTER TABLE expenses ADD CONSTRAINT fk_expenses_category_id FOREIGN KEY (category_id) REFERENCES categories (id) ON DELETE RESTRICT;

ALTER TABLE expenses ADD CONSTRAINT fk_expenses_subcategory_id FOREIGN KEY (subcategory_id) REFERENCES subcategories (id) ON DELETE SET NULL;

ALTER TABLE recurring_transactions ADD CONSTRAINT fk_recurring_transactions_category_id FOREIGN KEY (category_id) REFERENCES categories (id) ON DELETE RESTRICT;

ALTER TABLE recurring_transactions ADD CONSTRAINT fk_recurring_transactions_subcategory_id FOREIGN KEY (subcategory_id) REFERENCES subcategories (id) ON DELETE SET NULL;
